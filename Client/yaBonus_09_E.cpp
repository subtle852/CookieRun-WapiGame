...
namespace ya
{
	...
	void Bonus_09_E::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Bonus\\9_E", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"Bonus9_E", true);
	...
	void Bonus_09_E::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Bonus_09_E::Release()
	{
		GameObject::Release();
	}

	void Bonus_09_E::OnCollisionEnter(Collider* other)
	{

	}

	void Bonus_09_E::OnCollisionStay(Collider* other)
	{
	...
	void Bonus_09_E::OnCollisionExit(Collider* other)
	{
