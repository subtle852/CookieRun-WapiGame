...
namespace ya
{
	...
	void Bonus_03_N::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Bonus\\3_N", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"Bonus3_N", true);
	...
	void Bonus_03_N::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Bonus_03_N::Release()
	{
		GameObject::Release();
	}

	void Bonus_03_N::OnCollisionEnter(Collider* other)
	{

	}

	void Bonus_03_N::OnCollisionStay(Collider* other)
	{
	...
	void Bonus_03_N::OnCollisionExit(Collider* other)
	{
