...
namespace ya
{
	...
	void Bonus_01_B::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Bonus\\1_B", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"Bonus1_B", true);
	...
	void Bonus_01_B::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Bonus_01_B::Release()
	{
		GameObject::Release();
	}

	void Bonus_01_B::OnCollisionEnter(Collider* other)
	{
	...
	void Bonus_01_B::OnCollisionStay(Collider* other)
	{
		if (dynamic_cast<Character01*>(other->GetOwner()))
		{
	...
	void Bonus_01_B::OnCollisionExit(Collider* other)
	{
