...
namespace ya
{
	...
	void HpItemI::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Item\\HpItemI", Vector2::Zero, 0.1f,0);

		mAnimator->Play(L"ItemHpItemI", true);
	...
	void HpItemI::Update()
	{
		...
		{
			PlayScene::mCh01->IncreaseHP(15.0f);
			object::Destory(this);
		}
	...
	void HpItemI::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void HpItemI::Release()
	{
		GameObject::Release();
	}

	void HpItemI::OnCollisionEnter(Collider* other)
	{

	}

	void HpItemI::OnCollisionStay(Collider* other)
	{
	...
	void HpItemI::OnCollisionExit(Collider* other)
	{
