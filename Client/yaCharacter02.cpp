...
namespace ya
{
	...
	void Character02::Initialize()
	{
		...
		mAnimator->CreateAnimation(L"Up", mImage, Vector2((322.33f * 0), (322.33f * 3)), 15, 6, 1, Vector2::Zero, 0.1, 0);
		mAnimator->CreateAnimation(L"Down", mImage, Vector2((322.33f * 7), (322.33f * 3)), 15, 6, 1, Vector2::Zero, 0.1, 0);
	...
	void Character02::Update()
	{
		...
		if (scn->GetName() == L"Bonus")
		{
			...
			switch (mState)
			{
			case ya::eChar02State::Up:
				up();
				break;
			case ya::eChar02State::Down:
				down();
				break;
			}
		}
