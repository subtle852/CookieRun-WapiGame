...
namespace ya
{
	...
	void Bonus_05_S::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Bonus\\5_S", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"Bonus5_S", true);
	...
	void Bonus_05_S::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Bonus_05_S::Release()
	{
		GameObject::Release();
	}

	void Bonus_05_S::OnCollisionEnter(Collider* other)
	{

	}

	void Bonus_05_S::OnCollisionStay(Collider* other)
	{
	...
	void Bonus_05_S::OnCollisionExit(Collider* other)
	{
