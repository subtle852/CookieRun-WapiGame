	...
	void MakeScene::Update()
	{
		...
		if (GetFocus())
		{
			...
			if (Input::GetKeyDown(eKeyCode::LBUTTON))
			{
				...
				{
					mOb = object::Instantiate<L1_GT01>(Vector2(pos.x, 839.0f), eLayerType::Item);
				...
				{
					mOb = object::Instantiate<L1_GT02>(Vector2(pos.x, 839.0f), eLayerType::Item);
				...
				{
					mOb = object::Instantiate<L1_GT03>(Vector2(pos.x, 839.0f), eLayerType::Item);
				...
				{
					mOb = object::Instantiate<L1_OT01>(Vector2(pos.x, pos.y), eLayerType::Item);
				...
				{
					mOb = object::Instantiate<L1_OT02>(Vector2(pos.x, pos.y), eLayerType::Item);
				...
				{
					mOb = object::Instantiate<L1_OT03>(Vector2(pos.x, pos.y), eLayerType::Item);
		...
		if (Input::GetKeyState(eKeyCode::L) == eKeyState::Down)
		{
			...
			while (true)
			{
				...
				if (id2.ind == 0)
				{
					...
					mObs.insert(std::make_pair(id.id, mOb));// Reason to insert mObs : Magnet is activating at MakeScene Update with mObs
				}
				if (id2.ind == 1)
				{
