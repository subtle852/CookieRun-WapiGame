...
namespace ya
{
	...
	void Character01::Initialize()
	{
		...
		mAnimator->CreateAnimation(L"Up", mImage, Vector2((290.0f * 0), (290.0f * 3)), 11, 6, 1, Vector2::Zero, 0.1, 0);
		mAnimator->CreateAnimation(L"Down", mImage, Vector2((290.0f * 6), (290.0f * 3)), 11, 6, 1, Vector2::Zero, 0.1, 0);
	...
	void Character01::Update()
	{
		...
		if (scn->GetName() == L"Bonus")
		{
			...
			switch (mState)
			{
			case ya::eChar01State::Up:
				up();
				break;
			case ya::eChar01State::Down:
				down();
				break;
			}
		}
