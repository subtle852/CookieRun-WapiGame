...
namespace ya
{
	...
	void Bonus_06_T::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Bonus\\6_T", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"Bonus6_T", true);
	...
	void Bonus_06_T::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Bonus_06_T::Release()
	{
		GameObject::Release();
	}
	...
	void Bonus_06_T::OnCollisionExit(Collider* other)
	{
