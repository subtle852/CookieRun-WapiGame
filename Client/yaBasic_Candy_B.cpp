...
namespace ya
{
	...
	void Basic_Candy_B::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Item\\BasicJelly\\Candy\\Blue", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"CandyBlue", true);
	...
	void Basic_Candy_B::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Basic_Candy_B::Release()
	{
		GameObject::Release();
	}

	void Basic_Candy_B::OnCollisionEnter(Collider* other)
	{

	}

	void Basic_Candy_B::OnCollisionStay(Collider* other)
	{
	...
	void Basic_Candy_B::OnCollisionExit(Collider* other)
	{
