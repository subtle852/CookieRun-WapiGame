...
namespace ya
{
	...
	void Bonus_08_M::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Bonus\\8_M", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"Bonus8_M", true);
	...
	void Bonus_08_M::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Bonus_08_M::Release()
	{
		GameObject::Release();
	}

	void Bonus_08_M::OnCollisionEnter(Collider* other)
	{

	}

	void Bonus_08_M::OnCollisionStay(Collider* other)
	{
	...
	void Bonus_08_M::OnCollisionExit(Collider* other)
	{
