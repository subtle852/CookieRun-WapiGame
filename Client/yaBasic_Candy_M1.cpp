...
namespace ya
{
	...
	void Basic_Candy_M1::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Item\\BasicJelly\\Candy\\M1", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"CandyM1", true);
	...
	void Basic_Candy_M1::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Basic_Candy_M1::Release()
	{
		GameObject::Release();
	}

	void Basic_Candy_M1::OnCollisionEnter(Collider* other)
	{

	}

	void Basic_Candy_M1::OnCollisionStay(Collider* other)
	{
	...
	void Basic_Candy_M1::OnCollisionExit(Collider* other)
	{
