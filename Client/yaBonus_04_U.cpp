...
namespace ya
{
	...
	void Bonus_04_U::Initialize()
	{
		...
		mAnimator->CreateAnimations(L"..\\Resources\\Bonus\\4_U", Vector2::Zero, 0.1f, 0);

		mAnimator->Play(L"Bonus4_U", true);
	...
	void Bonus_04_U::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void Bonus_04_U::Release()
	{
		GameObject::Release();
	}

	void Bonus_04_U::OnCollisionEnter(Collider* other)
	{

	}

	void Bonus_04_U::OnCollisionStay(Collider* other)
	{
	...
	void Bonus_04_U::OnCollisionExit(Collider* other)
	{
